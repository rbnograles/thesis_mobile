              ...
              <View style={[styles.modalView]}>
                ...
                <ScrollView style={{ height: 300}}>
                  <Text style={styles.break}>
                    <Text style={{ color: Colors.primary, fontWeight: "bold"}}>JuanBreath</Text> is a contact tracing mobile application developed to help the nation [to] manage emerging infectious diseases. This application aims to elevate and utilize the contact tracing solution in the Philippines.
                  </Text>
                  <Text style={styles.break}>Before continuing to use the mobile application, users are required to agree to the terms and conditions of the application. Here are the <Text style={{fontWeight: "bold"}}>terms and conditions:</Text></Text>
                  <View style={[styles.break, styles.ulList]}>
                    <Text style={styles.break}>•	Users must only provide true and authentic information. Any form of misinformation from the users will not be tolerated and may have possible legal action.</Text>
                    <Text style={styles.break}>•	Proper usage of the application and its process is required to fully utilize the benefits of contact tracing. </Text>
                    <Text style={styles.break}>•	Abuse of the application’s features are prohibited.</Text>
                    <Text style={styles.break}>•	When confirmed positive of the infectious disease monitored by the application, that user will be required to upload their full information and location history on the system’s admin website. This will help the administrators to trace possible close contacts within a certain number of days.</Text>
                    <Text style={styles.break}>•	Any spread of information from the application through the user’s phone is excluded from the developers’ responsibility for leaked information.</Text>
                    <Text style={styles.break}>•	Resulting information from the use of this mobile and web application will be used in the thesis paper and research journal of the developers. All user information from the system will not be distributed to the public.</Text>
                  </View>
                  <Text style={{ fontSize: 20, fontWeight: "bold", marginBottom: 20}}>Privacy Policies</Text>
                  <Text style={{ color: Colors.primary, fontWeight: "bold", fontSize: 18, marginBottom: 10}}>•	Account Creation</Text>
